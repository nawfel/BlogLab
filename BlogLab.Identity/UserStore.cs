...
namespace BlogLab.Identity
{
        ...
        IUserPasswordStore<ApplicationUserIdentity>
    {
        ...
        public UserStore(IAccountRepository accountRespository)
        {
        ...
        {
            return await _accountRespository.GetByUsernameAsync(normalizedUserName, cancellationToken);
        }
        public async Task<IdentityResult> CreateAsync(ApplicationUserIdentity user, CancellationToken cancellationToken)
        {
            return await _accountRespository.CreateAsync(user, cancellationToken);
        }
